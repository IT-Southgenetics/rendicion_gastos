    ...
    <div className="w-full max-w-full space-y-5">
      ...
      {workflowStatus === "paid" && (
        <div className="flex w-full items-center gap-3 rounded-2xl border border-blue-200 bg-gradient-to-r from-blue-50 to-blue-100/50 px-4 py-3">
          ...
          <div className="min-w-0">
            <p className="text-sm font-bold text-blue-800">Rendición pagada</p>
            <p className="text-[0.7rem] text-blue-600/80">El pago fue registrado exitosamente.</p>
          </div>
        </div>
      )}
      ...
      <div className="flex w-full flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:gap-2">
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            {workflowStatus === "paid" ? "Pagada" : workflowStatus === "approved" ? "Aprobada" : report.status === "open" ? "Abierta" : "Cerrada"}
          </span>
          {budgetMax && (
            <span
